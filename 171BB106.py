...
def menu(): #MAIN MENU
    ...
    menu.mainloop()
re=Tk() #FRONT PAGE
re.configure(bg='olive')
Label(re,text="Python Project",font="gigi 20").pack()
Label(re,text="Name:",font="algerian 20").pack()
Label(re,text="Sahil jain",font="arial 20").pack()
Label(re,text="Enr. no.:",font="algerian 20").pack()
